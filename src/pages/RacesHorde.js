...
const Races = (props) => {
    ...
    return(
        <div style={{ backgroundColor: `${hordeRacesPageContent[props.selectedRace].color}` }}>
            <section id="main-section" className="internal-full-pages main-section" style={{ backgroundImage: `url(${hordeRacesPageContent[props.selectedRace].mainBackground})` }}>
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-12 col-lg-6">
                            <h1 className="internal-title">{hordeRacesPageContent[props.selectedRace].name}</h1>
                            <h2 className="internal-subtitle">{hordeRacesPageContent[props.selectedRace].quote}</h2>
                        </div>
                        <div className="col-12 col-lg-6 d-flex justify-content-center">
                            <img className="" alt={hordeRacesPageContent[props.selectedRace].mainCharacter} src={hordeRacesPageContent[props.selectedRace].mainCharacter}></img>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-12">
                            <div className="stylized-title horde-title">
                                <h1>{hordeRacesPageContent[props.selectedRace].title}</h1>
                            </div>
                            <div className="content main-text">
                                <p>{hordeRacesPageContent[props.selectedRace].description}</p>
                            </div>
                            <div className="stylized-title horde-title">
                                <h1>{`${hordeRacesPageContent[props.selectedRace].name} History`}</h1>
                            </div>
                            <div className="content main-text">
                                <p>{hordeRacesPageContent[props.selectedRace].history}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style={{ position: 'relative' }}>
                <div className="background-section" style={{ backgroundImage: `url(${hordeRacesPageContent[props.selectedRace].pageRaceBackground})` }}></div>
            ...
            <section id="home-land" className="internal-section">
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-lg-12">
                            <div className="stylized-title horde-title">
                                <h1>Home Zone - {hordeRacesPageContent[props.selectedRace].zone}</h1>
                            </div>
                            <div className="content main-text">
                                <p>{hordeRacesPageContent[props.selectedRace].zoneDescription}</p>
                            </div>
                            <img className="img-fluid mt-5 mb-5" src={hordeRacesPageContent[props.selectedRace].homeZoneImage} alt={hordeRacesPageContent[props.selectedRace].homeZoneImage}></img>
                            <div className="stylized-title horde-title">
                                <h1>Home City - {hordeRacesPageContent[props.selectedRace].city}</h1>
                            </div>
                            <div className="content main-text">
                                <p>{hordeRacesPageContent[props.selectedRace].cityDescription}</p>
                            </div>
                            <img className="img-fluid mt-5 mb-5" src={hordeRacesPageContent[props.selectedRace].homeCityImage} alt={hordeRacesPageContent[props.selectedRace].homeCityImage}></img>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="content w-100 d-flex flex-wrap">
                            <RacesCrestList races={factionSelected} pageId={hordeRacesPageContent[props.selectedRace].id} />
                        </div> 
                    </div>
                </div>
            </section>
